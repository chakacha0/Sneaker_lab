...
export default function EditPromoCodeModal({
  ...
  useEffect(() => {
    if (editingPromoCode) {
      if (editingPromoCode.discount_percent) {
        setDiscountType("percent");
      } else if (editingPromoCode.discount_amount) {
        setDiscountType("amount");
      }
    }
  }, [editingPromoCode]);

  if (!isOpen || !editingPromoCode) return null;
    ...
    <div style={modalOverlayStyle} onClick={onClose}>
      <div style={modalContentStyle} onClick={(e) => e.stopPropagation()}>
        <div style={modalHeaderStyle}>
          <h2 style={modalTitleStyle}>Edit Promo Code</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={onSubmit}>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <input
              type="date"
              value={formatDateForInput(newPromoCode.valid_from)}
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <input
              type="date"
              value={formatDateForInput(newPromoCode.valid_to)}
          ...
          <div style={{ marginBottom: "20px", padding: "10px", background: "#f0f0f0", borderRadius: "8px" }}>
            <div style={{ fontSize: "12px", color: "#666", fontFamily: "'Fragment Mono', monospace" }}>
              Used: {editingPromoCode.used_count || 0} {editingPromoCode.usage_limit ? `of ${editingPromoCode.usage_limit}` : ""}
            </div>
          </div>
